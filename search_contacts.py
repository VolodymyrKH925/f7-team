...
#     return [record for record in contacts.values() if query.lower() in record.name.value.lower()]

# def search_contacts_by_phone(query, contacts):
#     return [record for record in contacts.values()
...
#     return [record for record in contacts.values()
#             if hasattr(record, 'birthday') and record.birthday and query in record.birthday.value]
...
#             for value in record.address.values():
